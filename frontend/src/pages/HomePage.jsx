...
const LegalModal = lazy(function () {
  return import("../components/homepage/LegalModal.jsx");
});
...
function HomePage() {
  ...
  function toggleFaq(index) {
    setOpenFaqIndex(function (currentIndex) {
  ...
  function getFaqChevronClassName(index) {
    let className = "w-5 h-5 shrink-0 transition-transform";
      ...
      <main className="relative w-full min-h-0 flex-1 bg-[color-mix(in_oklab,var(--color-primary)_10%,var(--color-base-200))] overflow-y-auto scroll-smooth">
        <div className="relative min-h-full bg-base-200">
          ...
          <section className="relative w-full -mt-4 px-6 py-12 flex justify-center items-center">
            <div className="w-full max-w-4xl rounded-2xl border-4 border-[#e3e3e8] bg-[#e3e3e8]">
              <img
                ...
                alt="Aperçu du tableau de bord JobTrace"
                width="1280"
                height="1271"
              />
            </div>
              ...
              <div className="w-full mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {features.map(function (feature) {
                  return (
                    ...
                    >
                      <div className="h-full flex flex-col justify-start items-stretch gap-4">
                        <div className="flex items-center gap-3">
                          ...
                          <h3 className="min-w-0 text-lg font-bold leading-snug text-base-content">
                            {feature.title}
                          </h3>
                        </div>
          ...
          <section className="relative w-full -mt-4 px-6 py-12 flex justify-center items-center">
            <div className="w-full max-w-6xl mx-auto flex flex-col justify-center items-center gap-6">
              <div className="w-full max-w-2xl mx-auto flex flex-col justify-center items-center gap-6 text-center">
                ...
                <p className="max-w-xl text-base md:text-lg leading-relaxed text-base-content/60">
                  Retrouvez les réponses aux principales questions que vous nous avez posées concernant{" "}
              ...
              <div className="w-full max-w-4xl mt-6 flex flex-col justify-start items-stretch gap-2">
                <div className="rounded-2xl bg-base-100 shadow-sm">
                  <button
                    id="faq-question-0"
                    className="w-full min-h-14 px-4 py-4 flex items-center justify-between gap-4 text-left cursor-pointer touch-manipulation"
                    type="button"
                    onClick={function () {
                      toggleFaq(0);
                    }}
                  ...
                  >
                    <span className="min-w-0 flex-1 text-lg font-bold text-base-content">
                      À quoi sert{" "}
                      <span className="font-bold text-base-content">
                        Job<span className="text-primary">Trace</span>
                      </span>
                    ...
                    <ChevronDown
                      className={getFaqChevronClassName(0)}
                      aria-hidden="true"
                    />
                  </button>
                  ...
                  {openFaqIndex === 0 && (
                    ...
                    >
                      <p className="text-sm text-base-content/60">
                        ...
                        {"\u00A0"}vous permet de centraliser vos candidatures,
                        vos contacts, vos documents et vos relances afin de suivre
                        votre recherche d’emploi depuis un espace unique.
                      </p>
                    </div>
                  )}
                </div>
                ...
                <div className="rounded-2xl bg-base-100 shadow-sm">
                  ...
                  >
                    <span className="min-w-0 flex-1 text-lg font-bold text-base-content">
                      ...
                      {"\u00A0"}est-il adapté à une recherche de stage ou
                      d’alternance ?
                    </span>

                    <ChevronDown
                      className={getFaqChevronClassName(1)}
                      aria-hidden="true"
                    />
                  </button>
                  ...
                  {openFaqIndex === 1 && (
                    ...
                    >
                      <p className="text-sm leading-relaxed text-base-content/60">
                        ...
                        {"\u00A0"}peut être utilisé pour organiser une recherche
                        d’emploi, de stage ou d’alternance, quel que soit le
                        secteur d’activité.
                      </p>
                    </div>
                  )}
                ...
                <div className="rounded-2xl bg-base-100 shadow-sm">
                  ...
                  >
                    ...
                    <ChevronDown
                      className={getFaqChevronClassName(2)}
                      aria-hidden="true"
                    />
                  </button>
                  ...
                  {openFaqIndex === 2 && (
                    ...
                    >
                      <p className="text-sm text-base-content/60">
                        ...
                        {"\u00A0"}est une application web accessible directement
                        depuis votre navigateur. Il suffit de créer un compte pour
                        commencer à gérer vos candidatures.
                      </p>
                    </div>
                  )}
                </div>
                ...
                <div className="rounded-2xl bg-base-100 shadow-sm">
                  ...
                  >
                    ...
                    <ChevronDown
                      className={getFaqChevronClassName(3)}
                      aria-hidden="true"
                    />
                  </button>
                  ...
                  {openFaqIndex === 3 && (
                    ...
                    >
                      <p className="text-sm text-base-content/60">
                        ...
                        {"\u00A0"}est actuellement accessible gratuitement. Vous
                        pouvez créer un compte, gérer vos candidatures et profiter
                        de l'ensemble des fonctionnalités disponibles sans
                        abonnement.
                      </p>
                    </div>
                  )}
                ...
                <div className="rounded-2xl bg-base-100 shadow-sm">
                  ...
                  >
                    ...
                    <ChevronDown
                      className={getFaqChevronClassName(4)}
                      aria-hidden="true"
                    />
                  </button>
          ...
          <div className="relative w-full">
            ...
            {/* Footer */}
            <footer className="relative z-10 w-full px-6 py-6 md:py-0 md:pb-6">
              <div className="w-full max-w-6xl mx-auto">
                ...
                <div className="w-full mt-6 pt-6 flex flex-col md:flex-row justify-between items-center gap-3 border-t border-base-content/15">
